    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(
                    ...
                    // Разделение на public/protected, protected с middleware авторизации
                    .service(web::scope("")
                        .service(handlers::public::scope())  // /api/health, /api/auth/*
                    )
                    // Protected routes second (with auth middleware):
                    .service(
                        web::scope("")
                            .wrap(JwtAuthMiddleware::new(auth_service.keys().clone()))
                            .service(handlers::protected::scope())  // /api/accounts, /api/transfers
                    )
            )
    })
